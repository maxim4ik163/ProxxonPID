...
// =========================== CONFIG ===========================
#define MAX_TARGET_EMF 15500  // для proxxon Vmax=18V. максимальный целевой BEMF [мВ] 
#define DIV_R1 10000          // верхнее плечо делителя [Ом]
#define DIV_R2 2700           // нижнее плечо делителя [Ом] для Vin=20V
...
#define MIN_VMOT 3000       // минимальное питание [мВ]
...
void setup() {
  ...
  pinMode(13, OUTPUT);	 
  digitalWrite(13, HIGH);	//Индикатор работы D13
}
